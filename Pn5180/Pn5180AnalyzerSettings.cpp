...
bool Pn5180AnalyzerSettings::SetSettingsFromInterfaces()
{
...
void Pn5180AnalyzerSettings::LoadSettings( const char* settings )
{
	...
	if( strcmp( name_string, "SaleaePn5180Analyzer" ) != 0 )
		AnalyzerHelpers::Assert( "SaleaePn5180Analyzer: Provided with a settings string that doesn't belong to us;" );
...
const char* Pn5180AnalyzerSettings::SaveSettings()
{
	SimpleArchive text_archive;

	text_archive << "SaleaePn5180Analyzer";
	text_archive <<  mMosiChannel;
	text_archive <<  mMisoChannel;
	text_archive <<  mClockChannel;
	text_archive <<  mEnableChannel;
...
void Pn5180AnalyzerSettings::UpdateInterfacesFromSettings()
{
	mMosiChannelInterface->SetChannel( mMosiChannel );
	mMisoChannelInterface->SetChannel( mMisoChannel );
	mClockChannelInterface->SetChannel( mClockChannel );
